...
fctSfty_rc = makeRC "fctSfty" factorOfSafety fcSfty_desc fcSfty_rel fctSftyL
...
nrmShrFor_rc = makeRC "nrmShrFor" (nounPhraseSP "normal/shear force ratio")
...
intsliceFs_rc = makeRC "intsliceFs" (nounPhraseSP "interslice forces")
...
forDisEqlb_rc = makeRC "forDisEqlb"
...
rfemFoS_rc = makeRC "rfemFoS" (nounPhraseSP "RFEM factor of safety")
...
crtSlpId_rc = makeRC "crtSlpId" (nounPhraseSP "critical slip identification")
