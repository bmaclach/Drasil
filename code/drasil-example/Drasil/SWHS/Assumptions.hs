...
assumpS2 = foldlSent [
  ...
  phrase time, sSqBr $ mkRefFrmLbl nwtnCoolingL]
assumpS3 = foldlSent [
  ...
  sSqBr $ mkRefFrmLbl rocTempSimpL `sC` (makeRef dd2HtFluxP)]
assumpS4 = foldlSent [
...
assumpS5 = foldlSent [
  ...
  sSqBr $ mkRefFrmLbl rocTempSimpL]
assumpS6 = foldlSent [
  ...
  phrase vol, sSqBr $ mkRefFrmLbl rocTempSimpL]
assumpS7 = foldlSent [
...
assumpS8 = foldlSent [
  ...
  sSqBr $ makeRef dd1HtFluxC `sC` mkRefFrmLbl likeChg2L]
assumpS9 = foldlSent [
  S "The", phrase temp_C, S "does not vary along its length",
  sSqBr $ makeRef dd1HtFluxC `sC` mkRefFrmLbl likeChg3L]
assumpS10 = foldlSent [
  CT.law_conv_cooling ^. defn, S "applies between the",
...
assumpS14 = foldlSent [
  ...
  phrase boil_pt, sSqBr $ mkRefFrmLbl eBalanceOnWtrL `sC` mkRefFrmLbl heatEInWtrL]
assumpS15 = foldlSent [
  S "The", phrase tank, S "is", phrase perfect_insul,
  S "so that there is no", phrase CT.heat, S "loss from the",
  phrase tank, sSqBr $ mkRefFrmLbl eBalanceOnWtrL]
...
assumpS17 = foldlSent [
  ...
  S "due to", phrase CT.melting, S "is negligible", sSqBr $ mkRefFrmLbl eBalanceOnPCML]
assumpS18 = foldlSent [
...
assumpS19 = foldlSent [
  ...
  Sy (unit_symb temp) `sC` S "respectively", sSqBr $ mkRefFrmLbl eBalanceOnWtrL
   `sC` mkRefFrmLbl heatEInWtrL]
assumpS20 = foldlSent [
  S "When considering the", phrase w_vol, S "in the",
  phrase tank `sC` (phrase vol `ofThe` phrase coil),
  S "is assumed to be negligible", sSqBr $ mkRefFrmLbl inputInitQuantsL]
